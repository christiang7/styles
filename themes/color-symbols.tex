...
\newcommand{\ctextbf}[1]{\textcolor{color-bold}{\textbf{#1}}}

\newcommand{\cemph}[1]{\textcolor{color-emphasis}{\emph{#1}}}

\newcommand{\cunderline}[1]{\textcolor{color-mark}{\underline{#1}}}

\newcommand{\ctextsf}[1]{\textcolor{color-code}{\textsf{#1}}}
...
\newcommand{\oupdelta}{{\opcolor{color-function-operator}\updelta}}
\newcommand{\ovary}{{\opcolor{color-function-operator}\updelta}}
\newcommand{\osum}{{\opcolor{color-function-operator}{\sum}}}
\newcommand{\ooint}{{\opcolor{color-function-operator}{\int}}}
\newcommand{\opartial}{{\opcolor{color-function-operator}\partial}}
...
\newcommand{\miin}{{\color{color-index}\boldsymbol{n}}}
\newcommand{\mim}{{\color{color-index}\boldsymbol{m}}}
...
\newcommand{\ddA}{{\ddot{\fA_{\phantom{,}}}}\! }%\color{color-general-variable}
